                        ...
                        <div className="content-column col-lg-6 col-md-12">
                            <div className="inner-column wow fadeInRight">
                                <div className="sec-title">
                                    ...
                                    <div className="bold-text">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words.</div>
                                    <div className="text">You need to be sure there isn't anything embarrassing hidden in the middle of text. All the lorem generators on the Internet.</div>
                                </div>
                        ...
                        <div className="image-column col-lg-6 col-md-12 col-sm-12">
                            <div className="inner-column">
                                <div className="image-box">
                                    <figure className="bg-image"><img src="images/resource/image-6.jpg" title="Vixoz" /></figure>
                                    <figure className="image"><img src="images/resource/image-5.jpg" title="Vixoz" /></figure>
                                    <div className="info-box">
                                        <i className="icon flaticon-licensing" />
                                        <span className="count">4,89000</span>
                                        <div className="text">We Process Clients Visa’s only in 20 Days</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="banner-box-three">
                        <div className="inner-box">
                            <div className="title-column">
                                <figure className="image"><img src="images/resource/image-7.jpg" title="Vixoz" /></figure>
                                <h3 className="title">Skilled Visa’s in Global Immigration Sumit</h3>
                            </div>
