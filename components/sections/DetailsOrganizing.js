...
const DetailsOrganizing = ({ data, links  }) => {
          ...
          <div className="row">
            ...
            <div className="col-xl-8 col-lg-8">
              ...
              <div>
                ...
                <ul>
                  <li>
                    <h2>{data.organizing_for_canada.title}</h2>
                    <div dangerouslySetInnerHTML={{ __html: data.organizing_for_canada.body }} />
                  </li>
...
export default DetailsOrganizing;
