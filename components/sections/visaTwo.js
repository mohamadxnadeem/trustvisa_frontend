                ...
                <div className="image-box">
                  <figure className="image">
                    <Link href="page-visa-details">
                      <img src="images/resource/service-4.jpg" title="Vixoz" />
                    </Link>
                  </figure>
            ...
            <div className="service-block-two col-lg-3 col-md-6 col-sm-12 wow fadeInUp">
              <div className="inner-box">
                <div className="image-box">
                  <figure className="image">
                    <Link href="page-visa-details">
                      <img src="images/resource/service-5.jpg" title="Vixoz" />
                    </Link>
                  </figure>
                  <div className="icon-box">
            ...
            <div className="service-block-two col-lg-3 col-md-6 col-sm-12 wow fadeInUp">
              <div className="inner-box">
                <div className="image-box">
                  <figure className="image">
                    <Link href="page-visa-details">
                      <img src="images/resource/service-6.jpg" title="Vixoz" />
                    </Link>
                  </figure>
                  <div className="icon-box">
            ...
            <div className="service-block-two col-lg-3 col-md-6 col-sm-12 wow fadeInUp">
              <div className="inner-box">
                <div className="image-box">
                  <figure className="image">
                    <Link href="page-visa-details">
                      <img src="images/resource/service-7.jpg" title="Vixoz" />
                    </Link>
                  </figure>
                  <div className="icon-box">
